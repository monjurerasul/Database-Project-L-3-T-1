<%-- 
    Document   : ShowRetailerOrder
    Created on : 13-Dec-2016, 16:13:28
    Author     : Hasan Murad
--%>
...
<html>
  ...
  <form method="post" action="UpdateOrderProductList.do" onsubmit="return validate()">
            ...
            <input type="submit" value="Confirm Update Order"/><br/><br/>
   </form>
   <form method="post" action="DeleteAllComfirmOrder.do">
        <input type="submit" value="Delete All Comfirm Order"/>
   </form>    
  
<br/><a href="OrderRetailer.jsp"><button type="button">Back</button></a><br/>
<script>
