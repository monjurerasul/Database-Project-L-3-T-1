 ...
 * @author Hasan Murad
 */
@WebServlet(name = "UpdateMPOTable", urlPatterns = {"/UpdateMPOTable.do"})
public class UpdateMPOTable extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       boolean exist = db.UpdateDM(Integer.parseInt(employee_id),Integer.parseInt(password),first_name,last_name,Integer.parseInt(area_id),Integer.parseInt(salary));
        ...
        if(exist==true)
        {
          ...
          Vector<Employee> exist1=db.getMPOList(e.employee_id);
          session.setAttribute("mpolist", exist1);  
