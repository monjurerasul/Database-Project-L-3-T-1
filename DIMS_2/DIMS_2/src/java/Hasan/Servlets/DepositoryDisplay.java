 ...
 * @author Hasan Murad
 */
@WebServlet(name = "DepositoryDisplay", urlPatterns = {"/DepositoryDisplay.do"})
public class DepositoryDisplay extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Vector<Depository> exist=db.getDepository(e.employee_id);
        ...
        {
            session.setAttribute("depository", exist);
